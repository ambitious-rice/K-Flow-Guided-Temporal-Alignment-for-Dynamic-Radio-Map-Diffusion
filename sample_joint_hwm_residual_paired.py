#!/usr/bin/env python3
"""Paired DDIM evaluation for jointly trained HWM adapter + residual head."""
...
from sample_hwm_decoder_adapter_paired import (
...
def main() -> None:
    args = parse_args()
    args.adapter_checkpoint = args.joint_checkpoint
    ...
    student = JointHWMResidualStudent(
        base_model,
    ...
    payload = torch.load(args.joint_checkpoint, map_location="cpu")
