#!/usr/bin/env python3
"""Train temporal adapters in both RMDM prior and diffusion decoders."""
...
from dual_decoder_adapter_student import DualDecoderAdapterStudent
...
def save_checkpoint(model: DualDecoderAdapterStudent, args: argparse.Namespace, step: int, path: Path) -> None:
...
def main() -> None:
    ...
    model = DualDecoderAdapterStudent(
        base_model,
